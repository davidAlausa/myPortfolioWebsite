...
<template>
    ...
    <section class="mt-10 p-10">
        <h1 class=" text-7xl font-bold mt-5 md:mt-20 text-accentDARK">Hi,</h1>
        <p class="max-w-[100ch] justify-between">
            ...
            think of myself as a jack of all trades, master of simplification and a  
            devoted "Have you tried turning it off and on again?" troubleshooter.
            <br>
            <br>
